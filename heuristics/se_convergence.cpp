...
{   
    ...
    string thresh_file = "../networks/" + network_type + "/" + network_name + "/" + network_name + "_random_thresh_memoryful.txt";
    ...
    NN N = SynchronousUpdateMemoryful2(S.neighbors, S.threshold, C);
